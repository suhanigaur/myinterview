...
const page = () => {
  return (
    ...
    //   <h1 className='red font-bold text-[22px]'>Welcome to AI Powered Interview</h1>
    ...
    <div>
            ...
            <nav className="flex flex-col sm:flex-row flex-wrap items-center justify-between mt-4 md:mt-0 space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <div>
                <a
                  ...
                  href="https://github.com/AI-Powered-Interview/AI-Powered-Interview">
        ...
        <section id="features" className="py-16 bg-white px-6 md:px-0">
          <div className="container mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-gray-800">
              Our AI Powered Interview platform offers a range of powerful features:
            </p>
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/3 px-4 py-8">
                <div className="bg-blue-100 rounded-lg p-6 shadow-md">
                  <h3 className="text-2xl font-semibold text-black-600">AI Powered Interviews</h3>
              ...
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  <p className="text-gray-600">
                    "The AI Powered Interviews were incredibly helpful. I felt much more confident going into my real interview."
                  </p>
      ...
      <footer className="py-8 bg-black text-white text-center">
        <p>© 2024 AI Powered Interview. All rights reserved.</p>
      </footer>
    </div>
  )
}
